										...
										<div class="card-sigin">
                                            ...
                                            @endif
												...
												<form method="POST" action="{{ route('login.user') }}">
                                                    @csrf
													<div class="form-group">
														<label>Email</label> <input class="form-control" name="email" :value="old('email')" placeholder="Enter your email" type="email">
													</div>
													<div class="form-group">
												...
												<div class="main-signin-footer mt-5">
													...
													<p>{{ trans('Dashboard/login_trans.Do_not') }} <a href="{{ url('/' . $page='signup') }}">{{ trans('Dashboard/login_trans.Create') }}</a></p>
												</div>
                                            </div>
											</div>
